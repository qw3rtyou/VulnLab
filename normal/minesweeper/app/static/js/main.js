/*----- constants -----*/
var bombImage = '<img src="/static/images/bomb.png">';
var flagImage = '<img src="/static/images/flag.png">';
var wrongBombImage = '<img src="/static/images/wrong-bomb.png">';
var sizeLookup = {
...
if (window.location.hash) {
  size = parseInt(window.location.hash.replace("#", ""));
}
...
function buildTable() {
  var sizeRow = window.location.hash
  ...
  <tr>
    <td class="menu" id="window-title-bar" colspan="${size}">
      ...
      <div id="window-controls"><img src="/static/images/window-controls.png"></div>
    </td>
  <tr>
    ...
    <tr>
      <td class="menu" colspan="${size}">
          <section id="status-bar">
            ...
            <div id="reset"><img src="/static/images/smiley-face.png"></div>
...
function render() {
  ...
  if (hitBomb) {
    document.getElementById("reset").innerHTML =
      "<img src=/static/images/dead-face.png>";
    runCodeForAllCells(function (cell) {
    ...
    document.getElementById("reset").innerHTML =
      "<img src=/static/images/cool-face.png>";
    clearInterval(timerId);
  }
}
